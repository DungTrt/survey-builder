...
{
    public class UploadAnswerHistoryRepository : RepositoryBaseAsync<UploadAnswerHistory, long, SurveyBuilderContext>, IUploadAnswerHistoryRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public UploadAnswerHistoryRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
