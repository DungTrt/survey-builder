...
{
    public class AccountStatusRepository : RepositoryBaseAsync<AccountStatus, int, SurveyBuilderContext>, IAccountStatusRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public AccountStatusRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
