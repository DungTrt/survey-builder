...
{
    public class AccountSurveyAnswerRepository : RepositoryBaseAsync<AccountSurveyAnswer, long, SurveyBuilderContext>, IAccountSurveyAnswerRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public AccountSurveyAnswerRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
