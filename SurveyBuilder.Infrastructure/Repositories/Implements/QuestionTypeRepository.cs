...
{
    public class QuestionTypeRepository : RepositoryBaseAsync<QuestionType, int, SurveyBuilderContext>, IQuestionTypeRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public QuestionTypeRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
