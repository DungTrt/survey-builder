...
{
    public class AccountSurveyRepository : RepositoryBaseAsync<AccountSurvey, long, SurveyBuilderContext>, IAccountSurveyRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public AccountSurveyRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
