...
{
    public class UploadBillHistoryRepository : RepositoryBaseAsync<UploadBillHistory, long, SurveyBuilderContext>, IUploadBillHistoryRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public UploadBillHistoryRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
