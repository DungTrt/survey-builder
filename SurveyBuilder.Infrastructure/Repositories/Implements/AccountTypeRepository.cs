...
{
    public class AccountTypeRepository : RepositoryBaseAsync<AccountType, int, SurveyBuilderContext>, IAccountTypeRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public AccountTypeRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
