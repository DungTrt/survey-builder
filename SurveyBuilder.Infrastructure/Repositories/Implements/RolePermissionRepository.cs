...
{
    public class RolePermissionRepository : RepositoryBaseAsync<RolePermission, long, SurveyBuilderContext>, IRolePermissionRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public RolePermissionRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
