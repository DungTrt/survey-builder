...
{
    public class AccountCategoryRepository : RepositoryBaseAsync<AccountCategory, int, SurveyBuilderContext>, IAccountCategoryRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public AccountCategoryRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
