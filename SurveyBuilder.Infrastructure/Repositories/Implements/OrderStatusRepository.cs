...
{
    public class OrderStatusRepository : RepositoryBaseAsync<OrderStatus, int, SurveyBuilderContext>, IOrderStatusRepository
    {
        private readonly SurveyBuilderContext db;
        private readonly IUnitOfWork<SurveyBuilderContext> unitOfWork;
        public OrderStatusRepository(SurveyBuilderContext _dbContext, IUnitOfWork<SurveyBuilderContext> _unitOfWork) : base(_dbContext, _unitOfWork)
        {
